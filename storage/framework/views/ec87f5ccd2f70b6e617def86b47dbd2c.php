...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid px-4 py-2">
                        ...
                        <select class="form-select shadow-sm" name="payment_method">
                            ...
                            <?php $__currentLoopData = $availablePaymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($method); ?>"
                                    <?php echo e(request('payment_method') == $method ? 'selected' : ''); ?>>
                                    <?php echo e($paymentMethodLabels[$method] ?? str_replace('_', ' ', ucwords($method, '_'))); ?>
        ...
        <div class="row g-4 mb-5">
            <?php $__currentLoopData = [['icon' => 'bi-wallet2', 'color' => 'white', 'title' => 'Total Pendapatan', 'value' => 'Rp ' . number_format($totalRevenue, 0, ',', '.')], ['icon' => 'bi-cart-check', 'color' => 'black', 'title' => 'Total Pesanan', 'value' => number_format($totalOrders, 0, ',', '.')]]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-12 col-md-6">
                    <div class="stats-card h-100 shadow-sm bg-white p-2 rounded">
                        <div class="card-body d-flex align-items-center p-4">
                            ...
                            <div>
                                <h6 class="text-muted mb-2"><?php echo e($stat['title']); ?></h6>
                                <h2 class="mb-0 fw-bold"><?php echo e($stat['value']); ?></h2>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table table-hover custom-table mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $topProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($product->produk->nama); ?></td>
                                            <td class="text-center"><?php echo e(number_format($product->total_sales)); ?></td>
                    ...
                    <div class="card-body p-0 bg-transparent">
                        <div class="table-responsive">
                            <table class="table table-hover custom-table">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $topPackages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($package->paket->nama); ?></td>
                                            <td class="text-center"><?php echo e(number_format($package->total_sales)); ?></td>
                                            <td class="text-end">Rp
                                                <?php echo e(number_format($package->total_revenue, 0, ',', '.')); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                new Chart(salesCtx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            data: <?php echo json_encode($monthlySales->pluck('total_sales')); ?>,
                ...
                // Transform labels
                const labels = <?php echo json_encode($paymentMethods->pluck('payment_method')); ?>.map(method =>
                ...
                new Chart(paymentCtx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            data: <?php echo json_encode($paymentMethods->pluck('total')); ?>,
                            backgroundColor: [
                                '#667eea',
                                '#43e97b',
                                '#764ba2',
            ...
            function exportData(type) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location.href = '<?php echo e(route('admin.laporan.export')); ?>?' + params;
                    }
                });
            }
                ...
                inputs.forEach(input => {
                    if (input.type === 'date') {
                        ...
                        if (input.name === 'start_date') {
                            input.value = '<?php echo e($startDate->format('Y-m-d')); ?>';
                        } else if (input.name === 'end_date') {
                            input.value = '<?php echo e($endDate->format('Y-m-d')); ?>';
                        }
...
<?php echo $__env->make('layouts.admin.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Kenanga-Catering\resources\views/admin/laporan/index.blade.php ENDPATH**/ ?>