                        ...
                        <tbody>
                            <?php $__currentLoopData = $pakets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $paket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($paket->deskripsi); ?></td>
                                    ...
                                    <td class="text-center">
                                        <?php if($paket->foto): ?>
                                            <img src="<?php echo e(asset('storage/' . $paket->foto)); ?>" alt="<?php echo e($paket->nama); ?>"
                                                width="50" height="50" class="rounded-circle cursor-pointer"
                                                data-bs-toggle="modal" data-bs-target="#imageModal-<?php echo e($paket->id); ?>">
                                        <?php else: ?>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2 justify-content-center">
                                            <button class="btn btn-sm btn-warning" data-bs-toggle="modal"
                                                data-bs-target="#editPaketModal-<?php echo e($paket->id); ?>">
                                                <i class="fas fa-edit me-1"></i> Edit
                                            </button>
                                            <form action="<?php echo e(route('admin-paket.destroy', $paket->id)); ?>" method="POST"
                                ...
                                <!-- Image Modal -->
                                <div class="modal fade" id="imageModal-<?php echo e($paket->id); ?>" tabindex="-1">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title"><?php echo e($paket->nama); ?></h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                            </div>
                                            <div class="modal-body text-center">
                                                <img src="<?php echo e(asset('storage/' . $paket->foto)); ?>"
                                                    alt="<?php echo e($paket->nama); ?>" class="img-fluid rounded">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- Edit Modal -->
                                <div class="modal fade" id="editPaketModal-<?php echo e($paket->id); ?>" tabindex="-1">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <form action="<?php echo e(route('admin-paket.update', $paket->id)); ?>" method="POST"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="nama"
                                                            value="<?php echo e($paket->nama); ?>" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Deskripsi</label>
                                                        <textarea class="form-control" name="deskripsi" rows="3" required><?php echo e($paket->deskripsi); ?></textarea>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Harga</label>
                                                        <input type="number" class="form-control" name="harga"
                                                            value="<?php echo e($paket->harga); ?>" required>
                                                    </div>
                                                    <div class="mb-3">
...
<?php echo $__env->make('layouts.admin.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Kenanga-Catering\resources\views/admin/paket/index.blade.php ENDPATH**/ ?>