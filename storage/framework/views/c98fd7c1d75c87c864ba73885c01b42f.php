...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/navbar-admin.css')); ?>">
...
<body>
    ...
    <nav class="sidebar">
        <div class="sidebar-brand text-center">
            <img src="<?php echo e(asset('images/transparent.png')); ?>" alt="logo" class="me-2"
        ...
        <div class="sidebar-sticky">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('admin-produk.index') ? 'active' : ''); ?>"
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('admin-paket.index') ? 'active' : ''); ?>"
                        href="<?php echo e(route('admin-paket.index')); ?>">
                        <i class="fa-solid fa-gift me-2"></i>
                        Paket
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('transaksi.index') ? 'active' : ''); ?>"
...
<?php /**PATH C:\laragon\www\Kenanga-Catering\resources\views/layouts/admin/navbar.blade.php ENDPATH**/ ?>