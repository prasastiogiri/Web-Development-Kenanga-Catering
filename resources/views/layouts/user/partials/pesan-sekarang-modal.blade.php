{{-- layouts/user/partials/pesan-sekarang-modal.blade.php --}}
<style>
                    ...
                    <form id="pemesananForm" action="{{ route('pemesanan.store') }}" method="POST">
                        ...
                        <div class="card border-0 shadow-sm p-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control bg-light" id="userName" value="{{ auth()->user()->nama }}" readonly>
                            </div>
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="mb-3">
