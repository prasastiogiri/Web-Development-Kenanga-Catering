    ...
    <div class="footer-container">
        <div class="footer-section about">
            ...
            <ul class="footer-links">
                <li><a href="{{ route('homepage') }}" class="foot-link"><span>Beranda</span></a></li>
                <li><a href="{{ route('produkUser.index') }}" class="foot-link"><span>Produk</span></a></li>
                <li><a href="{{ route('paketUser.index') }}" class="foot-link"><span>Paket</span></a></li>
            </ul>
        </div>
